...
{
    class ParallelGeneticalAlgorithm
    {
        ...
        public ParallelGeneticalAlgorithm(int itemsAm, int dim, double[] rest, double[] costs, double[,] myItemsSet, int confAm, Crossover myCrs, Mutation myMt, double mutationPercentage)
        {
            itemsAmount = itemsAm;
            restrictions = rest;
            dimensions = dim;
